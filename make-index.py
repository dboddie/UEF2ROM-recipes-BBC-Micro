...
the <a href="https://github.com/dboddie/UEF2ROM-recipes-BBC-Micro">this repository</a>.
Each row in the table contains a link to the jsbeeb emulator, supplying the
URLs of the corresponding ROMs listed for that entry and the text of the
command needed to invoke the ROMs from BASIC. The order of the ROMs is
important because the first will have a higher priority than the second.
"""
...
for line in lines:
    ...
    link = jsbeeb_url + "?" + "&".join(js_urls) + "&autotype=" + command + "%0a"
